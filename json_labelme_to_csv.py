...
if __name__ == '__main__':
    ...
    json_annotation_directory = '/home/gil_diy/PycharmProjects/pytorch_interview_preparation_dec_2021/matches/resize_300'
    json_files = glob.glob(os.path.join(json_annotation_directory, '*.json'))
    all_rows = []
