...
if __name__ == '__main__':
    ...
    main_directory = "/home/gil_diy/PycharmProjects/pytorch_interview_preparation_dec_2021/Detecting_Facial_Keypoints"
    for image_type in ["training"]:
        print("***************", image_type, "***************")

        data_path = os.path.join(main_directory, image_type)
