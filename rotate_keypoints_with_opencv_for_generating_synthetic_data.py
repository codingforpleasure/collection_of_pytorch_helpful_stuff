...
if __name__ == '__main__':
    ...
    num_keypoints_per_img = int(len(original_keypoints_on_objects.columns) / 2)
    ...
    for filename_full_path in all_object_files:
        ...
        new_img2 = cv2.warpAffine(img_object, rotation_matrix, (new_dimensions[1], new_dimensions[0]))
        ...
        collection_of_original_keypoints = np.array([list(coordinates_object.values())]).reshape(num_keypoints_per_img,
                                                                                                 -1)
